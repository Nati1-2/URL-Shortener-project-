...
export const UrlTransformationAnimation: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-12 px-4 sm:px-6">
      <div className="p-1 rounded-3xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-2xl shadow-blue-500/20">
        <div className="bg-slate-900 dark:bg-slate-950 rounded-[22px] p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 text-white relative overflow-hidden">
          ...
          {/* Sparkle Connector */}
          {shouldReduceMotion ? (
            <div className="w-12 h-12 rounded-full bg-brand-gradient flex items-center justify-center text-white shadow-xl shrink-0 z-10 border border-white/30">
