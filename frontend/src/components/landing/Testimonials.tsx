...
import { Star, ShieldCheck, TrendingUp, Building2, Quote } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item, idx) => (
            <Card key={idx} hoverEffect className="flex flex-col justify-between space-y-6 p-8 border">
